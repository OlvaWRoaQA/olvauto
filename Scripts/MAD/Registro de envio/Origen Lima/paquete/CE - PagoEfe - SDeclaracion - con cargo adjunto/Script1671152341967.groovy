...
WebUI.callTestCase(findTestCase('MAD/CE'), [:], FailureHandling.STOP_ON_FAILURE)
...
//WebUI.setText(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text) - 03'), 'ica - ica - ica')
//WebUI.click(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/a_ICA - ICA - ICA'))
