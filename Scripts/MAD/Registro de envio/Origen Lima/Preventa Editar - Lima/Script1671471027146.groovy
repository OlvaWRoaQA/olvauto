...
WebUI.callTestCase(findTestCase('MAD/Registro de envio/Origen Lima/paquete/DNI - PagoEfe - SDeclaración'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/input_S_frmVentaContadotblEnvio0j_idt98'))

WebUI.setText(findTestObject('Object Repository/input_P. REAL_frmNewEnviopesoReal'), '3')
...
WebUI.click(findTestObject('Object Repository/span_Se solicit al cliente el pago por dife_df5e5a'))

WebUI.getText(findTestObject('Object Repository/span_Se solicit al cliente el pago por dife_df5e5a'), FailureHandling.STOP_ON_FAILURE)
