...
WebUI.callTestCase(findTestCase('MAD/Registro de envio/Origen Provincia/Paquete/DNI - Niubiz - SDeclaracion'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/input_P. REAL_frmNewEnviopesoReal'), '4')
...
WebUI.click(findTestObject('Olva Corp/despacho/Page_Principal - Olva Courier/span_Grabar1'))
