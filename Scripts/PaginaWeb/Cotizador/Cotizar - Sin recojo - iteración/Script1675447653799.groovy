...
WebUI.selectOptionByValue(findTestObject('Object Repository/select_Departamento Amazonas ncash Apurmac _a5a3d1_1'), departamento, 
    false)

WebUI.selectOptionByValue(findTestObject('Object Repository/select_ProvinciaChincha Ica Nasca Palpa Pisco'), provincia, 
    false)

WebUI.selectOptionByValue(findTestObject('Object Repository/select_DistritoIcaLa TinguiaLos AquijesOcuc_54656c'), distrito, 
    false)
...
precio2 = WebUI.getText(findTestObject('Object Repository/div_calculoTarifa'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual('S/ ' + precio, precio2)
