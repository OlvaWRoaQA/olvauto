...
monto_RE = WebUI.getText(findTestObject('div_calculoTarifa2'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual('S/ ' + monto_venta1, monto_RE, FailureHandling.CONTINUE_ON_FAILURE)
