...
WebUI.click(findTestObject('Object Repository/button_Editar'))

WebUI.setText(findTestObject('Object Repository/input_CARN EXT_txt_consignado_nombres (7)'), 'PRUEBAS 001.1')

WebUI.setText(findTestObject('Object Repository/input_cm_txt_paquete_peso (6)'), '1')
