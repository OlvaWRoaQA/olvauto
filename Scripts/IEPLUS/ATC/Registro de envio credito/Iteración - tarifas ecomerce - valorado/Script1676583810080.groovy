...
WebUI.setText(findTestObject('Object Repository/input_UTILES DE OFICINA_txt_paquete_valor (2)'), '550')
...
WebUI.setText(findTestObject('Object Repository/input_Provincia - Departamento - Distrito_f_0bcffb (2)'), destino)

WebUI.sendKeys(findTestObject('Object Repository/input_Provincia - Departamento - Distrito_f_0bcffb (2)'), Keys.chord(Keys.ENTER))
...
monto = WebUI.getText(findTestObject('div_calculoTarifa3'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual('S/ ' + total1, monto, FailureHandling.CONTINUE_ON_FAILURE)
