...
WebUI.setText(findTestObject('Object Repository/input_visualiza el reporte de los envos rea_257aad (1)'), '171735785')

WebUI.setEncryptedText(findTestObject('Object Repository/input_visualiza el reporte de los envos rea_152830 (1)'), 'aeHFOx8jV/A=')
...
WebUI.setText(findTestObject('Object Repository/input_Agregar Direccin Nueva_input-1 (1)'), 'pruebas tarifas SOBPQ')
...
WebUI.click(findTestObject('Object Repository/input_Entrega en Tienda_search'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/input_Entrega en Tienda_search'), destino)

WebUI.click(findTestObject('div_Vacio'))

WebUI.click(findTestObject('div_AVENIDA1'))
...
WebUI.setText(findTestObject('Object Repository/input_VALIJA-DOCUMENTOS___BVID__34 (1)'), 'impresoras')

WebUI.setText(findTestObject('Object Repository/input_VALIJA-DOCUMENTOS___BVID__68'), '2')

WebUI.setText(findTestObject('Object Repository/input_Mximo 20Kg___BVID__70'), '11')
...
WebUI.setText(findTestObject('Object Repository/input_Mximo 40cm___BVID__38'), '600')

WebUI.click(findTestObject('Object Repository/button_Programa tu recojo (1)'))

WebUI.click(findTestObject('label_Acepto leido DC'))

WebUI.click(findTestObject('label_Acepto DC'))

WebUI.click(findTestObject('button_AceptarDC'))

total2 = WebUI.getText(findTestObject('Object Repository/div_El precio del servicio a generar es de _f3c9ca (2)'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual('El precio del servicio a generar es de S/ ' + total, total2)

WebUI.click(findTestObject('Object Repository/button_Aceptar_1'))

WebUI.verifyElementVisible(findTestObject('Object Repository/button_OK'), FailureHandling.STOP_ON_FAILURE)
