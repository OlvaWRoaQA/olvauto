...
WebUI.click(findTestObject('Object Repository/span_FACTURACIN'))

WebUI.click(findTestObject('Object Repository/input_Ok_from'))
...
WebUI.click(findTestObject('Object Repository/i_arrow_drop_down'))

WebUI.click(findTestObject('Object Repository/svg_CANCELADO_iconify'))
