...
WebUI.click(findTestObject('Object Repository/div_PAQUETE (3)'))

WebUI.click(findTestObject('Object Repository/i_PAQUETE_dropdown icon'))

WebUI.click(findTestObject('Object Repository/div_ACCESORIOS PARA FIESTAS (2)'))

WebUI.setText(findTestObject('Object Repository/input_VALIJA-DOCUMENTOS___BVID__36 (2)'), 'impresora')

WebUI.setText(findTestObject('Object Repository/input_VALIJA-DOCUMENTOS___BVID__44'), '2')

WebUI.setText(findTestObject('Object Repository/input_Mximo 20Kg___BVID__46'), '14')

WebUI.setText(findTestObject('Object Repository/input_Mximo 40cm___BVID__48'), '14')

WebUI.setText(findTestObject('Object Repository/input_Mximo 40cm___BVID__50'), '14')

WebUI.setText(findTestObject('Object Repository/input_Mximo 40cm___BVID__38 (3)'), '2')

WebUI.setText(findTestObject('Object Repository/input_Mximo 40cm___BVID__40'), '200')
