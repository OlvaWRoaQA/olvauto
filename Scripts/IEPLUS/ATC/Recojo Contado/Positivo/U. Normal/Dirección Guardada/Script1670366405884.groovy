...
WebUI.click(findTestObject('Object Repository/label_Acepto los Trminos de uso y polticas _c209bf (1)'))
...
WebUI.click(findTestObject('Object Repository/button_Formato 909808707  16113000___BVID__23'))
...
WebUI.click(findTestObject('Object Repository/i_Buscar direccin de entrega_dropdown icon'))

WebUI.click(findTestObject('Object Repository/div_PAQUETE'))

WebUI.click(findTestObject('Object Repository/input_PAQUETE_input-18'))

WebUI.click(findTestObject('Object Repository/div_ACCESORIOS PARA FIESTAS'))

WebUI.setText(findTestObject('Object Repository/input_VALIJA-DOCUMENTOS___BVID__34 (1)'), 'pruebas')
...
WebUI.verifyElementText(findTestObject('Object Repository/div_El precio del servicio a generar es de _f3c9ca'), 'El precio del servicio a generar es de S/ 21.00')
