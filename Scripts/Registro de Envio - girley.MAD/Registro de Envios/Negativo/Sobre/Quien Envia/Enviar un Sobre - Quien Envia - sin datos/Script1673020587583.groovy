...
WebUI.verifyElementPresent(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/div_Ingrese correo electrnico'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/div_Ingrese formato correo electrnico'), 
    0)
