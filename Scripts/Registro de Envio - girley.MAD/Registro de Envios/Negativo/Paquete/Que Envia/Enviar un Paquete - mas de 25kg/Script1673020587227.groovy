...
WebUI.setText(findTestObject('Inicio/Page_Olva Courier  Datos Personales/input_cm_txt_paquete_peso'), '26')
...
WebUI.verifyTextPresent('El peso no puede excer los 25 Kgs.', false)
