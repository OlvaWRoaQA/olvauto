...
WebUI.click(findTestObject('Olva Corp/despacho/Page_Principal - Olva Courier/td_COMAS - COMAS - COMAS'))
...
WebUI.setText(findTestObject('Inicio/Page_Principal - Olva Courier/input_Direccin_Entrega_oc'), Keys.chord('el retablo mz k lt 29, comas, lima, lima'))

WebUI.sendKeys(findTestObject('Inicio/Page_Principal - Olva Courier/input_Direccin_Entrega_oc'), Keys.chord(Keys.ENTER, 
        Keys.ENTER))

WebUI.sendKeys(findTestObject('Inicio/Page_Principal - Olva Courier/input_Direccin_Entrega_oc2'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Page_Principal - Olva Courier/button_ACEPTAR2'))

WebUI.click(findTestObject('Page_Principal - Olva Courier/button_asignar_direccion'))
