...
WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_domiclio o tienda'))

WebUI.click(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/a_Entrega a domicilio'))

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/span_Provincia - Dpto - Distrito - Girley'))
...
WebUI.setText(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_Direccin de Entrega_address'), 
    'el retablo mz k lt 28')

WebUI.sendKeys(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_Direccin de Entrega_address'), 
    Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_Direccin de Entrega_direccion_new'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_Direccin de Entrega_direccion_new'), 
    'El retablo mz k lt 29, comas, lima, lima')

WebUI.click(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_Referencia_reference_new'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_Referencia_reference_new'), 
    'cerca del grifo')
...
WebUI.click(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/span_Tipo De Documento (1)'))

WebUI.click(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/a_DNI (2)'))

WebUI.setText(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_documento_receptor'), 
    '07000001')

WebUI.setText(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_telefono_receptor'), 
    '900000002')

WebUI.setText(findTestObject('Object Repository/Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_nombres_receptor'), 
    'RECEPTOR DE PRUEBA QA 001')

WebUI.scrollToElement(findTestObject('Olva Corp/Page_Olva Courier  Datos Personales/button_CONTINUAR'), 0)

WebUI.click(findTestObject('Olva Corp/Page_Olva Courier  Datos Personales/button_CONTINUAR'))
