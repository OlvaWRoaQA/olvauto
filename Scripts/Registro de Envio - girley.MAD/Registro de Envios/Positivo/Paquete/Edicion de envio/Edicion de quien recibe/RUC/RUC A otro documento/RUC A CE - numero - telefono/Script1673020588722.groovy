...
WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_CARN EXT (11)'))

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_documento_receptor'), '003000004')

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_telefono_receptor'), '900000004')
