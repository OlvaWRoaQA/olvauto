...
WebUI.click(findTestObject('Registro de Envio/Page_Olva Courier  Datos Personales/span_CARN EXT (2)'))

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_documento_receptor'), '002000001')
...
WebUI.click(findTestObject('Page_Olva Courier  Datos Personales/span_CE a DOC'))

WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_DNI (6)'))

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_documento_receptor'), '07000001')

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_telefono_receptor'), '900000003')

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_nombres_receptor'), 'RECEPTOR DE PRUEBA QA 002')
