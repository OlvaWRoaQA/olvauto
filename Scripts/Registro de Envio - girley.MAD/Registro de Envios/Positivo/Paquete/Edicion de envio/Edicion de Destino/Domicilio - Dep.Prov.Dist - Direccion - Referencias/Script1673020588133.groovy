...
WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_de tienda a domicilio'))
...
WebUI.sendKeys(findTestObject('Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text.edit)'), 
    Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/input_direccion_domicilio'), 
    'DIRECCION DE PRUEBA QA 002')
