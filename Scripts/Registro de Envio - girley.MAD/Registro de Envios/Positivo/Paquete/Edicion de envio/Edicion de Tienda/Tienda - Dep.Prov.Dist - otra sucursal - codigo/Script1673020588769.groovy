...
WebUI.scrollToElement(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_de domicilio a tienda'), 0)

WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_de domicilio a tienda'))

WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/a_Recojo en tienda'))

WebUI.click(findTestObject('Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (11)'))

WebUI.setText(findTestObject('Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text.cambio)'), 
    'lima - lima - santiago')

WebUI.sendKeys(findTestObject('Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text.cambio)'), 
    Keys.chord(Keys.ENTER))
