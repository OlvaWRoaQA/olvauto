...
WebUI.scrollToElement(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_LIMA - LIMA - RIMAC'), 0)

WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_LIMA - LIMA - RIMAC'), FailureHandling.STOP_ON_FAILURE)
