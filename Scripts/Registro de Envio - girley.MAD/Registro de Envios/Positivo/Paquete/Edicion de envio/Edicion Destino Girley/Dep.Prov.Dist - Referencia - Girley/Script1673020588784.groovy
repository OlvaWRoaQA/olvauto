...
WebUI.click(findTestObject('Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_Referencia'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_Referencia'), 'cerca del tambo')
