...
WebUI.click(findTestObject('Object Repository/Inicio/Page_Olva Courier  Confirma tus datos/img_sobre'))
...
WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/a_Entrega a domicilio 2'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (AA)'))

WebUI.setText(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text) - AA'), 
    'cusco - cusco - cusco')

WebUI.sendKeys(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text) - AA'), 
...
WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/a_DNI (2)'))
...
WebUI.click(findTestObject('Registro de Envio/Page_Olva Courier  Confirma tus datos/olvapromo-aceptar'))
