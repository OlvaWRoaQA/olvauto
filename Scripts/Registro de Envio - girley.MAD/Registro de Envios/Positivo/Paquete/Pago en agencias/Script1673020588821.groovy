...
WebUI.click(findTestObject('span_CUSCO - CUSCO - CUSCO'))
...
WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_ICA CA GUATEMALA URB SAN FRAN'))
...
WebUI.click(findTestObject('Olva Corp/Page_Olva Courier  Medios de pago/i_Pago en nuestras oficinas'))
