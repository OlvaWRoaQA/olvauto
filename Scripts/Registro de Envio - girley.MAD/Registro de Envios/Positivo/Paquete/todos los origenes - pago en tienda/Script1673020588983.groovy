...
WebUI.click(findTestObject('Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (2)'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text)'), 'cusco - cusco - cusco')
