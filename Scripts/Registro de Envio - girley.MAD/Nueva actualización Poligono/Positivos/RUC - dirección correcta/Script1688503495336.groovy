...
WebUI.click(findTestObject('objetos Laura/Page_Olva Courier  Datos Personales/span_RUC (Factura)'))
...
WebUI.sendKeys(findTestObject('Object Repository/objetos Laura/Page_Olva Courier  Datos Personales/a_LIMA - LIMA - SAN ISIDRO'), 
...
WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_No se encuentra tu direccin_address'), 
    'Av. las Begonias Nro. 545 San Isidro')
...
WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_Referencia_reference_new'), 'Urbanización Jardin')
