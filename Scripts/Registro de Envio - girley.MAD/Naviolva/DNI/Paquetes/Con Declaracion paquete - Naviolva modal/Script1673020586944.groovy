...
WebUI.click(findTestObject('Olva Corp/Page_Olva Courier  Medios de pago/i_Pago con tarjeta de crdito, dbito y yape'))
...
WebUI.click(findTestObject('Inicio/Page_Olva Courier  Confirma tus datos/button_PARTICIPAR_naviolva'))
