...
WebUI.setText(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text) - 03'), 
    'ica - ica - ica')
...
WebUI.click(findTestObject('Object Repository/Registro de Envio/Page_Olva Courier  Datos Personales/span_retorno de cargo'))

WebUI.click(findTestObject('Object Repository/Registro de Envio/Page_Olva Courier  Datos Personales/span_retorno de cargo - SI'))
...
WebUI.click(findTestObject('Object Repository/Inicio/Page_Olva Courier  Confirma tus datos/button_CAMBIAR'))

WebUI.click(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/span_domiclio o tienda - carga adjunto'))

WebUI.click(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/a_Recojo en tienda'))

WebUI.click(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (2)'))

WebUI.setText(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text) - CA3'), 
    'ica - ica - ica')

WebUI.sendKeys(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text) - CA3'), 
    Keys.chord(Keys.ENTER))
...
WebUI.click(findTestObject('Object Repository/Olva Corp/Page_Olva Courier  Confirma tus datos/button_ACEPTAR_CA'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/span_Aprobado y completado con exito'), 
    'Aprobado y completado con exito')

WebUI.click(findTestObject('Object Repository/Inicio/Page_Olva Courier  Confirma tus datos/button_PARTICIPAR_naviolva'))

WebUI.click(findTestObject('Inicio/Page_Olva Courier  Confirma tus datos/button_PARTICIPAR_naviolva - Circulo'), FailureHandling.STOP_ON_FAILURE)

WebUI.switchToWindowTitle('Template form')

WebUI.verifyElementText(findTestObject('Page_Template form/h1_mensaje_promo'), 'Recuerda, a más números de tracking, mayores posibilidades tendrás de ganar.')
