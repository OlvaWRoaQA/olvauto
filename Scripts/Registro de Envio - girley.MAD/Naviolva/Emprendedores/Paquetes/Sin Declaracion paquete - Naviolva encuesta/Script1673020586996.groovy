...
def formattedDate = todaysDate.format('dd/MM/yy hh:mm')

Date nextDate = new Date()

def AddDate = nextDate.format('dd/MM/yy hh:mm')
...
def futureDate = currentDate.format('dd/MM/yy hh:mm')
...
WebUI.setText(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/input_paquete_articulo'), futureDate)
