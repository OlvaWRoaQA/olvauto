...
WebUI.click(findTestObject('Olva Corp/Page_Olva Courier  Medios de pago/i_Pago en nuestras oficinas'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementNotPresent(findTestObject('Inicio/Page_Olva Courier  Confirma tus datos/button_PARTICIPAR_naviolva'), 
    0)

WebUI.verifyElementNotPresent(findTestObject('Inicio/Page_Olva Courier  Confirma tus datos/button_PARTICIPAR_naviolva - Circulo'), 
    0)

WebUI.verifyElementNotPresent(findTestObject('Inicio/Page_Olva Courier  Confirma tus datos/button_ENCUESTA_naviolva - Circulo'), 
    0)
