...
WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/input_tienda'))

WebUI.setText(findTestObject('Inicio/Page_Olva Courier  Datos Personales/input_tienda'), 't')

WebUI.sendKeys(findTestObject('Inicio/Page_Olva Courier  Datos Personales/input_tienda'), Keys.chord(Keys.ENTER))
...
monto_venta = WebUI.getText(findTestObject('Inicio/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/Page_Principal - Olva Courier/monto_base'), 
    FailureHandling.STOP_ON_FAILURE)

monto_exceso1 = WebUI.getText(findTestObject('Inicio/Page_Atencin al Cliente/Page_Principal - Olva Courier/monto_exceso'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyNotEqual(monto_venta, 'S/.0.00')

WebUI.verifyEqual(monto_exceso1, 'S/.0.00')

WebUI.verifyEqual(monto_venta, 'S/.11.90')
...
WebUI.waitForElementPresent(findTestObject('Olva Corp/despacho/Page_Principal - Olva Courier/nro_tracking venta contado'), 
    0)
