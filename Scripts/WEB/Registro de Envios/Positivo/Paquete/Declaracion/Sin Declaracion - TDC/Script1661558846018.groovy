...
WebUI.callTestCase(findTestCase('WEB/Inicio de Registro'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('WEB/Enviar un Paquete'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito'))

WebUI.setText(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/input_Provincia - Departamento - Distrito_f_0bcffb'), 
    'ica - ica - ica')
...
WebUI.clickOffset(findTestObject('Object Repository/Registro de Envio/Page_Olva Courier  Medios de pago/span'), 100, 800)

WebUI.click(findTestObject('Object Repository/Olva Corp/Page_Olva Courier  Confirma tus datos/button_PAGA AQUI'))
