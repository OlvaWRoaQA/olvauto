...
WebUI.callTestCase(findTestCase('Registro de Envio - girley.MAD/Registro de Envios/Positivo/Sobre/Sin Declaracion - con cargo adjunto'), 
...
WebUI.click(findTestObject('olvacorp/Page_Principal - Olva Courier/span_Venta'))
...
WebUI.click(findTestObject('Negativo/Page_Principal - Olva Courier/input_S_frmVentaContadotblEnvio0j_idt105'))

WebUI.click(findTestObject('Negativo/Page_Principal - Olva Courier/input_LECTORA_frmNewEnvioremManual'))

WebUI.setText(findTestObject('Negativo/Page_Principal - Olva Courier/input_LECTORA_frmNewEnvioremManual'), '12230860008')
...
WebUI.click(findTestObject('Olva Corp/Page_Principal - Olva Courier/span_editar_tracking'))
...
WebUI.click(findTestObject('Olva Corp/Distribucion/Distribucion/Page_Principal - Olva Courier/nro_tracking'))

nro_tracking1 = WebUI.getText(findTestObject('Olva Corp/despacho/Page_Principal - Olva Courier/nro_tracking'))
