...
WebUI.callTestCase(findTestCase('Registro de Envio - girley.MAD/Registro de Envios/Positivo/Paquete/Declaracion/Sin Declaracion - TDC sin fondos'), 
    [('nro_tdc') : 4474118355632240], FailureHandling.STOP_ON_FAILURE)

nro_pedido1 = WebUI.getText(findTestObject('Inicio/Page_Olva Courier  Datos Personales/nro de pedido - sin fondos'))
