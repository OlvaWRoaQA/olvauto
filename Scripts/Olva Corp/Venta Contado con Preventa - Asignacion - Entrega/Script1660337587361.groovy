...
WebUI.click(findTestObject('Olva Corp/Distribucion/Distribucion/Page_Principal - Olva Courier/input_EFECTIVO_frmTipoComprobanteefectivo'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Olva Corp/Distribucion/Distribucion/Page_Principal - Olva Courier/input_EFECTIVO_frmTipoComprobanteefectivo'), 
    '50')

WebUI.click(findTestObject('Olva Corp/Distribucion/Distribucion/Page_Principal - Olva Courier/span_GRABAR E IMPRMIR'))

WebUI.delay(5)

nro_tracking = WebUI.getText(findTestObject('Object Repository/Olva Corp/Distribucion/Distribucion/Page_Principal - Olva Courier/nro_tracking'))

WebUI.click(findTestObject('Object Repository/Olva Corp/Distribucion/Page_Principal - Olva Courier/span_Distribucion'))

WebUI.click(findTestObject('Object Repository/Olva Corp/Distribucion/Page_Principal - Olva Courier/span_Asignacion'))

WebUI.setText(findTestObject('Object Repository/Olva Corp/Distribucion/Page_Principal - Olva Courier/input_OPERADOR_frmAsignaciontxtCodigoOperador'), 
    'WMY')

WebUI.sendKeys(findTestObject('Object Repository/Olva Corp/Distribucion/Page_Principal - Olva Courier/input_OPERADOR_frmAsignaciontxtCodigoOperador'), 
    Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Olva Corp/Distribucion/Distribucion/input_CODIGO DE BARRAS_frmAsignaciontxtCodi_2f39f3'), 
    '022' + nro_tracking)

WebUI.sendKeys(findTestObject('Olva Corp/Distribucion/Distribucion/input_CODIGO DE BARRAS_frmAsignaciontxtCodi_2f39f3'), 
    Keys.chord(Keys.ENTER))
...
WebUI.click(findTestObject('Olva Corp/Page_Principal - Olva Courier/span_ENTREGA_radio'))

WebUI.click(findTestObject('Olva Corp/Page_Principal - Olva Courier/input_OPERADOR_frmLiquidacionEnviotxtCodigoOperador'))

WebUI.setText(findTestObject('Olva Corp/Page_Principal - Olva Courier/input_OPERADOR_frmLiquidacionEnviotxtCodigoOperador'), 
    'WMY')

WebUI.sendKeys(findTestObject('Olva Corp/Page_Principal - Olva Courier/input_OPERADOR_frmLiquidacionEnviotxtCodigoOperador'), 
    Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Olva Corp/Page_Principal - Olva Courier/input_CODIGO DE BARRAS_frmAsignaciontxtCodi_2f39f3'), 
    '02230860103')

WebUI.sendKeys(findTestObject('Olva Corp/Page_Principal - Olva Courier/input_CODIGO DE BARRAS_frmAsignaciontxtCodi_2f39f3'), 
    Keys.chord(Keys.ENTER))
