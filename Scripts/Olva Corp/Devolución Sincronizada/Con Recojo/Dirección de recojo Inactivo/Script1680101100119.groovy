...
WebUI.click(findTestObject('Object Repository/span_Clientes (7)'))

WebUI.click(findTestObject('Object Repository/span_Solicitar (7)'))
...
WebUI.click(findTestObject('Object Repository/span_Usar Direccin Recojo_ui-chkbox-icon ui_75ca65'))

WebUI.click(findTestObject('Object Repository/span_Editar'))

WebUI.click(findTestObject('Object Repository/span_Distribucion (1)'))

WebUI.click(findTestObject('Object Repository/span_Devolucin (1)'))

WebUI.setText(findTestObject('Object Repository/input_CODIGO DE BARRAS_frmDevolucioncodigoBarras'), '02300002410')
