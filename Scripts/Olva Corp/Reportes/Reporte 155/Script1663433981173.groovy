...
WebUI.click(findTestObject('Object Repository/reportes olva/Page_Intranet OLVA  Principal/a_155 Recepcion Linio -'))

WebUI.click(findTestObject('Object Repository/reportes olva/Page_Recepcin de Linio/button_Buscar (1)'))
