...
WebUI.setText(findTestObject('Object Repository/Olva Corp/despacho/Page_Principal - Olva Courier/input_DESTINO_frmUbigeoDestinofltDestino'), 
    'huanuco')

WebUI.sendKeys(findTestObject('Object Repository/Olva Corp/despacho/Page_Principal - Olva Courier/input_DESTINO_frmUbigeoDestinofltDestino'), 
    Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Olva Corp/despacho/Page_Principal - Olva Courier/td_PERU'))
...
WebUI.click(findTestObject('Object Repository/Olva Corp/despacho/Page_Principal - Olva Courier/input_Direccin_frmNewEnviodirEntrega'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/Olva Corp/despacho/Page_Principal - Olva Courier/input_Direccin_frmNewEnviodirEntrega'), 
    'av 28 de julio 1550')
