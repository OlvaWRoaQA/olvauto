...
WebUI.click(findTestObject('Page_Principal - Olva Courier/span_Atencin Cliente (1)'))

WebUI.click(findTestObject('Page_Principal - Olva Courier/span_Venta (1)'))

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/Page_Principal - Olva Courier/span_Buscar Preventa - pago'))
...
WebUI.click(findTestObject('Object Repository/Page_Principal - Olva Courier/span_Seleccionar'))

WebUI.click(findTestObject('Object Repository/Page_Principal - Olva Courier/span_Grabar_preventa'))
