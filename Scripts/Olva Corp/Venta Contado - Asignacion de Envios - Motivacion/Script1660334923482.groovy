...
WebUI.setText(findTestObject('Olva Corp/Distribucion/input_CODIGO DE BARRAS_frmLiquidaciontxtCodi_2'), '022' + nro_tracking)
...
WebUI.sendKeys(findTestObject('Olva Corp/Distribucion/input_CODIGO DE BARRAS_frmLiquidaciontxtCodi_2'), Keys.chord(Keys.ENTER))
