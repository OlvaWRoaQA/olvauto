...
WebUI.callTestCase(findTestCase('Registro de Envio - girley.MAD/Registro de Envios/Positivo/Paquete/Declaracion/Sin Declaracion - con cargo adjunto - 2kg'), 
...
WebUI.setText(findTestObject('Negativo/Page_Principal - Olva Courier/input_LECTORA_frmNewEnvioremManual'), '12230860009')
...
WebUI.click(findTestObject('Inicio/Page_Atencin al Cliente/Page_Principal - Olva Courier/input_clave_seguridad'))

WebUI.setText(findTestObject('Inicio/Page_Atencin al Cliente/Page_Principal - Olva Courier/input_clave_seguridad'), '0000')

WebUI.click(findTestObject('Inicio/Page_Principal - Olva Courier/input_clave_seguridad2'))

WebUI.setText(findTestObject('Inicio/Page_Principal - Olva Courier/input_clave_seguridad2'), '0000')

WebUI.click(findTestObject('Olva Corp/Distribucion/Distribucion/Page_Principal - Olva Courier/span_Grabar_codigo_seguridad'))
