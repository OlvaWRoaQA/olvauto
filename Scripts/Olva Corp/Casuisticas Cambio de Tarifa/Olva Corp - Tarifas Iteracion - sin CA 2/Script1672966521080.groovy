...
monto_total_venta = WebUI.getText(findTestObject('Inicio/Page_Atencin al Cliente/Page_Meet - pvd-uiyo-xob/Page_Olva Courier  Datos Personales/Page_Principal - Olva Courier/span_precion venta_olvacorp'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyEqual(monto_otros1, 'S/.0.00')

WebUI.verifyEqual(monto_total_venta, 'S/.' + Total1)
