...
WebUI.click(findTestObject('Olva Corp/Page_Principal - Olva Courier/td_HUANUCO_1'))
...
WebUI.sendKeys(findTestObject('Object Repository/Olva Corp/Distribucion/Page_Principal - Olva Courier/input_P. REAL_frmNewEnviopesoReal'), 
    Keys.chord(Keys.ENTER))

monto_exceso2 = WebUI.getText(findTestObject('Inicio/Page_Atencin al Cliente/Page_Principal - Olva Courier/monto_exceso'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyNotEqual(monto_base1, 'S/.0.00')

WebUI.verifyNotEqual(monto_exceso2, 'S/.0.00')

WebUI.verifyEqual(monto_base1, 'S/.7.63')

WebUI.verifyEqual(monto_exceso2, 'S/.2.12')

WebUI.click(findTestObject('Page_Olva Courier  Confirma tus datos/button_Editar'))
