...
WebUI.waitForElementClickable(findTestObject('Object Repository/Registro de Envio/Page_Olva Courier  Medios de pago/Page_Olva Courier  Medios de pago/Page_Olva Courier  Medios de pago/span_Tarjeta de crdito y dbito'), 
    0)
...
WebUI.click(findTestObject('Inicio/Page_Olva Courier  Confirma tus datos/button_OMITIR_naviolva'))

nro_pedido1 = WebUI.getText(findTestObject('Inicio/Page_Olva Courier  Datos Personales/nro de pedido - 1'))
