...
WebUI.setText(findTestObject('Negativo/Page_Principal - Olva Courier/input_LECTORA_frmNewEnvioremManual'), '12230860013')
...
WebUI.click(findTestObject('Negativo/Page_Principal - Olva Courier/input_EFECTIVO_frmTipoComprobanteefectivo2'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Negativo/Page_Principal - Olva Courier/input_EFECTIVO_frmTipoComprobanteefectivo2'), '50')
