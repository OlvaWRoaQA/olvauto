...
WebUI.setText(findTestObject('Negativo/Page_Principal - Olva Courier/input_LECTORA_frmNewEnvioremManual'), CA)
...
WebUI.verifyEqual(monto_base1, "S/." + Base)

WebUI.verifyEqual(monto_exceso1, "S/." + Exceso)

WebUI.verifyEqual(monto_otros1, 'S/.8.47')

//WebUI.verifyEqual(monto_IGV1, monto_RE)
