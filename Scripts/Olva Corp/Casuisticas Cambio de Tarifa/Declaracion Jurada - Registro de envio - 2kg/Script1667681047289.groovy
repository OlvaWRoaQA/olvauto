...
WebUI.callTestCase(findTestCase('Registro de Envio - girley.MAD/Registro de Envios/Positivo/Paquete/Declaracion/Con Declaracion - pago efectivo - 2kg'), 
...
WebUI.verifyEqual(monto_base1, 'S/.20.76')

WebUI.verifyEqual(monto_exceso1, 'S/.6.78')
