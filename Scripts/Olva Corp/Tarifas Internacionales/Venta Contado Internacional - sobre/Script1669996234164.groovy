...
WebUI.verifyMatch(valor_venta1, 'S/.688.46', true)
...
WebUI.click(findTestObject('Inicio/Page_Atencin al Cliente/Page_Principal - Olva Courier/input_Seleccionar_imagenservicio'))

WebUI.click(findTestObject('Olva Corp/despacho/Page_Principal - Olva Courier/span_Grabar - tracking'))

WebUI.click(findTestObject('Olva Corp/Distribucion/Page_Principal - Olva Courier/a_salir_track'))
