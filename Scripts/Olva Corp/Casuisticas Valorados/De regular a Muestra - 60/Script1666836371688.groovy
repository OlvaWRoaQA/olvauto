...
WebUI.setText(findTestObject('Olva Corp/despacho/Page_Principal - Olva Courier/input_SERVICIOS_frmNewEnvioservicio_input2'), 
    'MYP')

WebUI.sendKeys(findTestObject('Olva Corp/despacho/Page_Principal - Olva Courier/input_SERVICIOS_frmNewEnvioservicio_input2'), 
    Keys.chord(Keys.ENTER))

WebUI.verifyElementText(findTestObject('Inicio/Page_Atencin al Cliente/Page_Meet - pvd-uiyo-xob/Page_Olva Courier  Datos Personales/Page_Principal - Olva Courier/span_precion venta_olvacorp'), 
    'S/.60.00')
