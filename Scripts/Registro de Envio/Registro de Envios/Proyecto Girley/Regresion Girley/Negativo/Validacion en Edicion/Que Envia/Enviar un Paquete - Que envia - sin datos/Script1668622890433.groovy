...
WebUI.verifyElementPresent(findTestObject('Object Repository/Negativo/Page_Olva Courier  Datos Personales/div_Debe ingresar un valor mayor a cero'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/div_Las dimensiones mnimas deben ser 10cm x 10cm x 14cm o el equivalente'), 
    0)
