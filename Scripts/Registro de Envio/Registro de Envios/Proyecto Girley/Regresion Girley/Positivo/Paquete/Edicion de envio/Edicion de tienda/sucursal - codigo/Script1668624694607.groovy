...
WebUI.scrollToElement(findTestObject('Page_Olva Courier  Datos Personales/input_clave_recojo_tienda'), 0)

WebUI.click(findTestObject('Page_Olva Courier  Datos Personales/span_Tienda ATE maestra'))

WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_OLVA REAL PLAZA PURUCHUCO - ATE - AV JAVIER PRADO ESTE NRO 8680 URBANIZACION URB MAYORAZGO'), 
    FailureHandling.STOP_ON_FAILURE)
