...
WebUI.callTestCase(findTestCase('Registro de Envio/Registro de Envios/Proyecto Girley/Funcionales/domicilio girley - delcaracion jurada'), 
...
WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (22)'))
