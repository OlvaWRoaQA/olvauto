...
WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_paquete_valor'), '400')
...
WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_cm_txt_paquete_peso'), '1.5')
...
WebUI.click(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/a_ICA - ICA - ICA'))
...
WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_paquete_valor'), '1200')

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_paquete_largo'), '20')

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_cm_txt_paquete_ancho'), '15')

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_cm_txt_paquete_altura'), '25')

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_cm_txt_paquete_peso'), '3')

WebUI.scrollToPosition(0, 400)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (23)'))

WebUI.setText(findTestObject('Inicio/Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (22)'), 
    'amazonas - bagua - bagua')

WebUI.click(findTestObject('Inicio/Page_Olva Courier  Datos Personales/a_AMAZONAS - BAGUA - BAGUA'))

WebUI.setText(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/input_direccion_domicilio'), 
    'PRUEBA QA 002 DIRECCION')

WebUI.setText(findTestObject('Object Repository/Inicio/Page_Olva Courier  Datos Personales/input_direccion__referencia'), 
    'CASA GRIS DE PUERTA NEGRA')

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_documento_receptor'), '04000002')

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_telefono_receptor'), '990000003')

WebUI.setText(findTestObject('Object Repository/Page_Olva Courier  Datos Personales/input_nombres_receptor'), 'PRUEBA QA 002 RECEPTOR')
