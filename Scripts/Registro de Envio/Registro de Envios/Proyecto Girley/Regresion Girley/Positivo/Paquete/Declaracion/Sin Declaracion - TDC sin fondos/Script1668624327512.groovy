...
WebUI.openBrowser('https://registro.olvacourier.com/registrar_envios_promo')
...
WebUI.callTestCase(findTestCase('Registro de Envio/Registro de Envios/Proyecto Girley/Funcionales/domicilio girley - buscar direccion'), 
