...
WebUI.callTestCase(findTestCase('Registro de Envio/Inicio de Registro - Girley'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/span_Tipo De Documento'))

WebUI.click(findTestObject('Object Repository/Registro de Envio/Page_Olva Courier  Datos Personales/span_RUC'))

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_CARN EXT_txt_documento_cliente'), 
    '10066810581')

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_CARN EXT_txt_telefono_cliente'), 
    '900000001')
...
WebUI.click(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/span_Departamento - Provincia - Distrito'))

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_Departamento - Provincia - Distrito_f_f56910'), 
...
WebUI.click(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/span_Seleccionar artculo'))

WebUI.click(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/span_ACCESORIOS Y EQUIPOS ELEC'))

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_paquete_articulo'), 
    'Impresora QA 001')

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_paquete_valor'), 
    '400')

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_paquete_largo'), 
    '14')

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_cm_txt_paquete_ancho'), 
    '10')

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_cm_txt_paquete_altura'), 
    '10')

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_cm_txt_paquete_peso'), 
    '1.5')
...
WebUI.click(findTestObject('Page_Olva Courier  Datos Personales/canvas'))
...
WebUI.click(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/span_Tipo De Documento (1)'))

WebUI.click(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/a_DNI (2)'))

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_documento_receptor'), 
    '07000001')

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_telefono_receptor'), 
    '900000002')

WebUI.setText(findTestObject('Object Repository/Negativo/Page_Atencin al Cliente/Page_Olva Courier  Datos Personales/input_nombres_receptor'), 
