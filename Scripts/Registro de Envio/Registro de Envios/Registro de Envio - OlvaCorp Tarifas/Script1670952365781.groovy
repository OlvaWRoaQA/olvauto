...
monto_RE = WebUI.getText(findTestObject('Page_Olva Courier  Medios de pago/td_total registro de envio'), FailureHandling.STOP_ON_FAILURE)
...
monto_venta1 = WebUI.getText(findTestObject('Inicio/Page_Atencin al Cliente/Page_Meet - pvd-uiyo-xob/Page_Olva Courier  Datos Personales/Page_Principal - Olva Courier/span_precion venta_olvacorp'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyEqual(monto_venta1, monto_RE)
