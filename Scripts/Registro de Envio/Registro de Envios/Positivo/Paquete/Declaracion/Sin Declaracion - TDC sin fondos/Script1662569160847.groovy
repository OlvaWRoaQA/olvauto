...
WebUI.setText(findTestObject('Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text)'), 'LIMA - LIMA - SAN ISIDRO')

WebUI.sendKeys(findTestObject('Page_Olva Courier  Datos Personales/span_Provincia - Departamento - Distrito (text)'), Keys.chord(
        Keys.ARROW_DOWN))
...
WebUI.click(findTestObject('Olva Corp/Page_Olva Courier  Medios de pago/i_Pago con tarjeta de crdito, dbito y yape'), FailureHandling.STOP_ON_FAILURE)
