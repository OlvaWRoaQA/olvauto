...
WebUI.verifyElementNotPresent(findTestObject('Registro de Envio/Page_Olva Courier  Datos Personales/span_OlvaNavi'), 0)

WebUI.verifyElementNotPresent(findTestObject('Registro de Envio/Page_Olva Courier  Datos Personales/span_OlvaNavi1'), 0)

WebUI.verifyElementNotPresent(findTestObject('Registro de Envio/Page_Olva Courier  Datos Personales/span_OlvaEncuesta'), 
    0)
