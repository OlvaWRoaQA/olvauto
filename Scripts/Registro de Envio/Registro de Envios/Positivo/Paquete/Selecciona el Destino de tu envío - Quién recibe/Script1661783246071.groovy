...
WebUI.callTestCase(findTestCase('Registro de Envio/Registro de Envios/Positivo/Paquete/Selecciona el Destino de tu envío - Recojo en tienda'), 
...
WebUI.callTestCase(findTestCase('Registro de Envio/Registro de Envios/Positivo/Paquete/Selecciona el Destino de tu envío - Entrega a Domicilio'), 
    [:], FailureHandling.STOP_ON_FAILURE)
