...
WebUI.setText(findTestObject('Object Repository/input_CARN EXT. (Boleta)_txt_documento_cliente (2)'), '20508371901')
...
WebUI.click(findTestObject('button_CerrarParticipar'))

WebUI.verifyElementClickable(findTestObject('button_Participar2'))

WebUI.click(findTestObject('button_Participar2'))
