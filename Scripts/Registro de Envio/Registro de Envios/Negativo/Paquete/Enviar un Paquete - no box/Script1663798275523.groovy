...
WebUI.openBrowser('https://registro.olvacourier.com/registrar_envios_mad/nuevo-envio')
...
WebUI.verifyElementText(findTestObject('Inicio/Page_Olva Courier  Confirma tus datos/button_CONTINUAR_gris'), 'CONTINUAR')
