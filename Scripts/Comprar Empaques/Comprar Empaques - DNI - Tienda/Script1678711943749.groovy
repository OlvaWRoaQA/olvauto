...
WebUI.setText(findTestObject('Object Repository/Comprar Empaques/Page_Olva Courier  Datos Personales/input_El apellido ingresado debe ser igual _544e76'), 
    'Benites')

WebUI.click(findTestObject('Object Repository/Comprar Empaques/Page_Olva Courier  Datos Personales/button_Validar'))
