...
WebUI.navigateToUrl('https://registro.olvacourier.com/registrar_envios_cajas/nuevo-registro')
...
WebUI.verifyTextPresent('Debe seleccionar minimo 3 cajas para entregar en tienda o 10 para domicilio', true)
...
WebUI.verifyElementText(findTestObject('Object Repository/Comprar Empaques/Page_Olva Courier  Datos Personales/div_La cantidad mnima es 1'), 
    'Debe tener mínimo 3 cajas añadidas')
